...
const { authenticateSeller, requireStoreOwnership, requireAdmin } = require('../middleware/auth.middleware');

// Rutas base: /api/stores
router.get('/', storeController.getStores);
router.get('/:id', storeController.getStoreById);
router.get('/:id/admin-details', requireAdmin, storeController.getAdminStoreDetails);
router.put('/:id/status', requireAdmin, storeController.updateStoreStatus);
router.put('/:id/zelle', requireAdmin, storeController.updateZelleInfo);
...
router.get('/:id/stats', authenticateSeller, requireStoreOwnership, storeController.getStoreStats);
